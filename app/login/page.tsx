...
export default function LoginPage() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-blue-50 via-slate-50 to-cyan-100 flex items-center justify-center px-6 overflow-hidden relative">
      ...
      <section className="relative z-10 w-full max-w-6xl grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        <div>
          ...
          <p className="text-slate-600 text-2xl leading-relaxed max-w-xl">
            Login to access your startup dashboard, investors, mentors,
            projects and AI-powered collaboration tools.
          </p>
          ...
          <div className="flex gap-6 mt-12 flex-wrap">
            <div className="bg-white/80 backdrop-blur-2xl rounded-[30px] shadow-2xl border border-white/60 p-8 w-44">
              <h3 className="text-5xl font-black text-blue-600">500+</h3>
              <p className="font-bold text-slate-600 mt-3">Startups</p>
            </div>

            <div className="bg-white/80 backdrop-blur-2xl rounded-[30px] shadow-2xl border border-white/60 p-8 w-44">
              <h3 className="text-5xl font-black text-cyan-600">200+</h3>
              <p className="font-bold text-slate-600 mt-3">Investors</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white/80 backdrop-blur-3xl rounded-[40px] shadow-2xl border border-white/70 p-10">
          ...
          <input
            ...
            className="w-full h-16 rounded-2xl border border-slate-200 bg-white/90 px-6 mb-6 outline-none text-slate-800 shadow-sm focus:ring-4 focus:ring-blue-200"
          />
          ...
          <input
            ...
            className="w-full h-16 rounded-2xl border border-slate-200 bg-white/90 px-6 mb-8 outline-none text-slate-800 shadow-sm focus:ring-4 focus:ring-blue-200"
          />
