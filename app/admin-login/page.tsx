      ...
      <section className="relative z-10 w-full max-w-6xl grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        <div>
          ...
          <p className="text-slate-600 text-2xl leading-relaxed max-w-xl">
            Manage users, events, AI courses, verifications,
        ...
        <div className="bg-white/80 backdrop-blur-3xl rounded-[40px] shadow-2xl border border-white/70 p-10 hover:shadow-blue-200/50 transition-all duration-300">
          ...
          <input
            ...
            className="w-full h-16 rounded-2xl border border-slate-200 bg-white/90 px-6 mb-6 outline-none text-slate-800 shadow-sm focus:ring-4 focus:ring-blue-200 transition-all"
          />
          ...
          <input
            ...
            className="w-full h-16 rounded-2xl border border-slate-200 bg-white/90 px-6 mb-8 outline-none text-slate-800 shadow-sm focus:ring-4 focus:ring-blue-200 transition-all"
          />
          ...
          <div className="space-y-5">
            ...
            <button
              onClick={goNext}
              className="w-full h-16 rounded-2xl bg-slate-950 text-white font-black text-lg shadow-xl hover:scale-[1.02] hover:shadow-2xl transition-all duration-300"
            >
              Login →
            </button>
