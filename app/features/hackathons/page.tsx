    ...
    <main className="min-h-screen bg-[#f4f8ff] flex items-center justify-center p-10 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-6xl w-full rounded-[48px] bg-white/60 backdrop-blur-3xl border border-white/80 shadow-2xl p-16">
        <div className="flex items-center gap-6 mb-10">
          ...
          <div>
            ...
            <p className="text-xl text-slate-600 mt-3">
              Discover events, form teams and prepare winning submissions.
            </p>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {[
            ["📅", "Upcoming Events", "Explore hackathons and innovation challenges."],
            ["🤝", "Team Registration", "Create or join teams for hackathon participation."],
            ["📤", "Project Submission", "Track submissions, demos and final presentations."],
          ].map(([icon, title, text]) => (
            <div
              key={title}
